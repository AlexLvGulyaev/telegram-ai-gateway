...
**Подтверждение:** Скриншоты негативных сценариев в docs/screenshots/TGW_tg_errors.png

---

## ℹ️ 2. Общая информация
...
## 📊 14. Результаты инженерного тестирования
